...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carousels.forEach(function(carousel) {
        carousel.addEventListener('afterChange', function(event) {
            ...
            const productInfos = document.querySelectorAll('.image-hotspots-container .product-info');
            const productDots = document.querySelectorAll('.image-hotspots-container .product-dot');
            ...
            const currentProductInfo = document.querySelectorAll('.image-hotspots-container')[currentSlide].querySelector('.product-info');
            const currentProductDot = document.querySelectorAll('.image-hotspots-container')[currentSlide].querySelector('.product-dot');
